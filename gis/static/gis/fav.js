...
function initMap() {
  ...
  map.controls[google.maps.ControlPosition.TOP_CENTER].push(centerRulerDiv);
        ...
        if(data.length == 0){
          const noPlacesYet = '<div class="row"><div class="col-lg-12" style="color:red;">You havent chosen any places yet</div></div>';
          document.querySelector('#listPlaces').insertAdjacentHTML('beforeend', noPlacesYet);
          return
